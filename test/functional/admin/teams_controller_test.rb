...
class Admin::TeamsControllerTest < ActiveSupport::TestCase
  ...
  def test_edit_name
    ...
    get(:edit_name, :id => vanilla.to_param)
    assert_response(:success)
    assert_template("admin/teams/_edit_name")
  ...
  def test_cancel_edit_name
    ...
    get(:cancel_edit_name, :id => vanilla.to_param, :name => vanilla.name)
    assert_response(:success)
    assert_template("admin/teams/_name")
    assert_not_nil(assigns["team"], "Should assign team")
    assert_equal(vanilla, assigns['team'], 'Team')
    vanilla.reload
  ...
  def test_toggle_member
    ...
    assert_response(:success)
    assert_template("admin/teams/_member")
    vanilla.reload
